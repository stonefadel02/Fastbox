<template>
                ...
                <div class="grid md:grid-cols-4 grid-cols-1 ml-1 md:mt-0 mt-10">
                    ...
                    <p class="text-gray-500  md:text-justify text-justify p-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        <div class="flex my-4 md:my-4 ml-4 ">
                          ...
                          <a href="#!" class="mr-6 text-white dark:text-neutral-200 w-8 h-6 rounded-sm bg-sky-400 sm:text-left">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="h-6 w-4 m-auto my-auto"
                              fill="currentColor"
                          ...
                          <a href="#!" class="mr-6 text-white dark:text-neutral-200 w-8 h-6 rounded-sm bg-blue-500 sm:text-left">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="h-6 w-4 m-auto my-auto"
                              fill="currentColor"
                          ...
                          <a href="#!" class="mr-6 text-white dark:text-neutral-200 w-8 h-6 rounded-sm bg-amber-800 sm:text-left">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  class="h-6 w-4 m-auto my-auto"
                                  fill="currentColor"
            ...
            <div class="bg-stone-800 h-16 py-6 text-center">
                 <p class="md:py-auto md:pl-20 text-white md:text-sm text-xs"> COPYRIGHTS © 2023 <a href="" class="text-[#db0f31]">TRANZLOGISTICS.</a>  DESIGNED BY <a href="" class="text-[#db0f31]">ZOZOTHEMES</a> </p> 
            </div>
