<template>
      <div class="grid grid-cols-4 grid-rows-1 bg-stone-900 h-24">
          <div class="ml-10" style=" display: flex;">
              <h1 class="text-4xl font-mono  mt-8 text-white text-center"  >FastBox</h1>
          ...
          <div class="flex mt-7 ml-28 ">
            <img src="./cask.png" alt="" class="h-10">
            <p class="text-white pl-5 text-sm"><span class="font-bold "><a href="" class="hover:text-[#db0f31]">+(123) 456-7890</a></span> <br>
              <a href="" class="hover:text-[#db0f31]">info@example.com</a></p>
          </div>
  
      </div>
      <div class="sticky top-0 grid grid-cols-2 my bg-stone-900  border-2 border-stone-800">
          <div class="my-3 ">
          <div class="relative inline-flex sm:w-auto mb-2 sm:mb-0 sm:mr-2" >
        <select  class="appearance-none bg-stone-900 
         border-gray-300 hover:border-gray-500
          px-4 py-2 pr-1 rounded shadow leading-tight
           focus:outline-none focus:shadow-outline
            text-white font-mono cursor-pointer
             hover:text-[#db0f31] font-bold">
        ...
        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-white">
                  <svg class="fill-current h-6 w-6 border-white " viewBox="0 0 20 20">
         ...
         <div class="relative inline-flex" >
            <select  class="appearance-none
             bg-stone-900  border-gray-300
              hover:border-gray-500 px-4 py-2 pr-1 
        ...
        <div class="relative inline-flex" >
            <select class="appearance-none
             bg-stone-900  border-gray-300
              ...
              shadow leading-tight focus:outline-none 
      ...
      <div class="relative inline-flex" >
                <select class="appearance-none bg-stone-900 
                 border-gray-300 hover:border-gray-500 px-4 py-2 pr-1 
                 rounded shadow leading-tight 
                 focus:outline-none focus:shadow-outline
                  text-white font-mono cursor-pointer
                   hover:text-[#db0f31] font-bold">
          ...
          <div class="relative inline-flex" >
                <select class="appearance-none
                 bg-stone-900  border-gray-300
                  hover:border-gray-500 px-4 py-2 pr-6
                   rounded shadow leading-tight 
                   focus:outline-none focus:shadow-outline
                    text-white font-mono cursor-pointer
                     hover:text-[#db0f31] font-bold">
                ...
                inset-y-0 right-0 flex items-center px-2 text-white">
                  <svg class="fill-current h-6 w-6 border-white " viewBox="0 0 20 20">
                    <path d="M10 12l-4-4h8l-4 4z"/>
                  </svg>
                </div>
                  ...
                  <div class="relative inline-flex" >
                    ...
                    <select class="appearance-none bg-stone-900 
                     border-gray-300 hover:border-gray-500 
                     px-4 py-2 pr-8 rounded shadow leading-tight
                      focus:outline-none focus:shadow-outline
                       text-white font-mono cursor-pointer
                        hover:text-[#db0f31] font-bold">
                    ...
                    <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-white">
                      ...
                      <div class="relative inline-flex" >
                    <select class="appearance-none bg-stone-900 
                     border-gray-300 hover:border-gray-500 px-4 py-2 pr-5 
                     rounded shadow leading-tight 
                     focus:outline-none focus:shadow-outline
                      text-white font-mono cursor-pointer
                       hover:text-[#db0f31] font-bold">
